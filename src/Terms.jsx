    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        ...
        <p>
          ...
          networks and changes to conform and adapt to technical requirements of connecting networks or devices. Credit
        ...
        <p>
          ...
          us you send creative ideas, suggestions, proposals, plans, or other materials, you agree that we may, at any time,
        ...
        <p>
          ...
          inaccuracies or omissions that may relate to product descriptions, pricing, promotions, offers, and availability.
        </p>
        
        <h2>PROHIBITED USES</h2>
        <p>
          In addition to other prohibitions, you are prohibited from using the site or its content for any unlawful
          purpose, to solicit others to perform unlawful acts, to violate international or federal regulations, and more.
        </p>
        
        <h2>DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
        <p>
          We do not guarantee that your use of our service will be uninterrupted, timely, secure or error-free. You agree
          that from time to time we may remove the service for indefinite periods of time or cancel the service at any time,
          without notice to you.
        </p>
        
        <h2>INDEMNIFICATION</h2>
        <p>
          You agree to indemnify, defend and hold harmless our company and affiliates, partners, officers, directors,
          agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, from any
          claim or demand.
        </p>
        ...
        <h2>GOVERNING LAW</h2>
        <p>
          These Terms of Service and any agreements whereby we provide you Services shall be governed by and construed in
          accordance with the laws of India and jurisdiction of Chennai, Tamil Nadu.
        </p>
      </div>
    </div>
  );
