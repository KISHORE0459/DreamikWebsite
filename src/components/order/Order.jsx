...
const Order = ({ handleEditOrder, orderData, setOrderData, coupon }) => {
  ...
  const offer =
    JSON.parse(sessionStorage.getItem("Nameslipoffer")) ||
    JSON.parse(sessionStorage.getItem("cutoutoffer"));
  ...
  useEffect(() => {
    if (offer) {
      if (
        parseInt(pincode) > 600000 &&
        parseInt(pincode) < 600118 &&
              ...
              <div id="prices1">
                ...
                {offer && (
                  <h3 className="offer-banner">
                    🚚🎉 Free Shipping for Chennai People till Weekend Periods
                    only! 🛍️✨ pincode Between 600001-600117
                  </h3>
                )}{" "}
              </div>
            </div>
            ...
            <div id="form-container">
              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  const reseller =
                    localStorage.getItem("ResellerLogin") || false;
